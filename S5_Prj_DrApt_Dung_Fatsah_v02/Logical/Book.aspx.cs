...
namespace S5_Prj_DrApt_Dung_Fatsah_v02
{
 ...
 protected void Page_Load(object sender, EventArgs e)
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        mail.Body = "Hi " + Session["name"].ToString() + " with ID " + Session["id"].ToString() + ", Your Appointment has been booked with Doctor '" + DropDownList3.SelectedItem + "' on the Date :'" + Calendar1.SelectedDate.ToShortDateString() + "' Time:'" + Label10.Text + "' ";
        ...
        mail1.To.Add(dmail);
        mail1.Subject = "A new Appointment Alert for you Dr " + DropDownList3.SelectedItem;
        mail1.Body = "Dr " +  DropDownList3.SelectedItem + ", you have an Appoinntment with User Id :'" + Session["id"].ToString() + "' with name '" + Session["name"].ToString() + "' on the Date :'" + Calendar1.SelectedDate.ToShortDateString() + "' Time:'" + Label10.Text + "' ";
